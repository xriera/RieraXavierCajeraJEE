...
a persistence unit "RieraXavierCajeraJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "RieraXavierCajeraJEE\pom.xml":
...
artifact ("RieraXavierCajeraJEE.war") is already built. You can build
